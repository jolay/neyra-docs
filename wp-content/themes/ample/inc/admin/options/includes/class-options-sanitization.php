...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'ample' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'ample' ),
		'repeat-y'  => __( 'Repeat Vertically', 'ample' ),
		'repeat'    => __( 'Repeat All', 'ample' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'ample' ),
		'top center'    => __( 'Top Center', 'ample' ),
		'top right'     => __( 'Top Right', 'ample' ),
		'center left'   => __( 'Middle Left', 'ample' ),
		'center center' => __( 'Middle Center', 'ample' ),
		'center right'  => __( 'Middle Right', 'ample' ),
		'bottom left'   => __( 'Bottom Left', 'ample' ),
		'bottom center' => __( 'Bottom Center', 'ample' ),
		'bottom right'  => __( 'Bottom Right', 'ample')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'ample' ),
		'fixed'  => __( 'Fixed in Place', 'ample')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'ample' ),
		'italic'      => __( 'Italic', 'ample' ),
		'bold'        => __( 'Bold', 'ample' ),
		'bold italic' => __( 'Bold Italic', 'ample' )
		);
